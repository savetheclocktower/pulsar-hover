...
async function renderOverlayContent({ markdown, 
// grammar = undefined,
containerClassName, contentClassName, editorStyles }) {
...
var _OverlayManager_instances, _OverlayManager_subscriptions, _OverlayManager_datatipRegistry, _OverlayManager_hoverRegistry, _OverlayManager_signatureHelpRegistry, _OverlayManager_watchedEditors, _OverlayManager_cursorMoveTimer, _OverlayManager_mouseMoveTimer, _OverlayManager_createTimers, _OverlayManager_getEditorBackgroundColor;
...
class OverlayManager {
    ...
    initialize() {
        __classPrivateFieldGet(this, _OverlayManager_subscriptions, "f").add(atom.config.observe("pulsar-hover.hover.hoverTime", () => {
            __classPrivateFieldGet(this, _OverlayManager_instances, "m", _OverlayManager_createTimers).call(this);
    ...
    async onTextDidChangeSignatureHelp(event, editor) {
        ...
        // character…
        ((_a = provider.triggerCharacters) === null || _a === void 0 ? void 0 : _a.has(potentialTriggerCharacter)) === true ||
            // …or if we just typed a retrigger character _and_ the overlay was
            // already open…
            (((_b = provider.retriggerCharacters) === null || _b === void 0 ? void 0 : _b.has(potentialTriggerCharacter)) && alreadyOpen) // ||
        // // …or it should not
...
_OverlayManager_subscriptions = new WeakMap(), _OverlayManager_datatipRegistry = new WeakMap(), _OverlayManager_hoverRegistry = new WeakMap(), _OverlayManager_signatureHelpRegistry = new WeakMap(), _OverlayManager_watchedEditors = new WeakMap(), _OverlayManager_cursorMoveTimer = new WeakMap(), _OverlayManager_mouseMoveTimer = new WeakMap(), _OverlayManager_instances = new WeakSet(), _OverlayManager_createTimers = function _OverlayManager_createTimers() {
    var _a, _b;
...
function buildParameterDocumentation(parameter, signature, grammarName = '') {
    var _a;
    let doc;
