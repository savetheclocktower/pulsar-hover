...
function buildSignatureHelpContext(mode, { character, isRetrigger = false } = {}) {
    ...
    switch (mode) {
        case 'triggered':
            triggerKind = vscodeLanguageserverProtocol.SignatureHelpTriggerKind.TriggerCharacter;
            break;
        case 'invoked':
            triggerKind = vscodeLanguageserverProtocol.SignatureHelpTriggerKind.Invoked;
            break;
        case 'content-changed':
            triggerKind = vscodeLanguageserverProtocol.SignatureHelpTriggerKind.ContentChange;
    }
