  ...
  mountOverlayWithMarker(
    ...
    element.addEventListener(
      ...
      (e) => {
        ...
        let overflowContainer = element.querySelector('.hover-overlay-view-container') as HTMLElement | undefined;
        if (!overflowContainer) {
          overflowContainer = (e.target as HTMLElement | undefined)?.closest('.hover-overlay-view-container') as HTMLElement | undefined;
        }
